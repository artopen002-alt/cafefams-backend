...
Never write item names in a single flowing sentence/paragraph. Always use ONE item per line, like this:
• **Café Latte** — ₹120
• **Cappuccino** — ₹110
• **Cold Coffee** — ₹130
Keep any extra commentary (like sold-out notices) brief and on a separate line, not woven into the list.
...
// Public — aggregated rating summary for customer-facing About page
app.get('/api/feedback/public', (req, res) => {
  if (!feedbackList.length) {
    return res.json({ success: true, avgRating: 0, totalReviews: 0, recent: [] });
  }
